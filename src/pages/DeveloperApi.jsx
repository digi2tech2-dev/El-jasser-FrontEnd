    ...
    <div className="mx-auto max-w-4xl space-y-5 px-4 pb-16 sm:px-6 lg:px-8">
      <Card className="rounded-2xl border border-[color:rgb(var(--color-primary-rgb)/0.3)] bg-[color:rgb(var(--color-card-rgb)/0.92)] p-6 shadow-[var(--shadow-subtle)]">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <Link to="/api-docs" className="inline-flex items-center justify-center gap-2 rounded-lg border border-[color:rgb(var(--color-primary-rgb)/0.35)] px-4 py-2 text-sm font-semibold text-[var(--color-primary)] transition hover:bg-[color:rgb(var(--color-primary-rgb)/0.08)]">
