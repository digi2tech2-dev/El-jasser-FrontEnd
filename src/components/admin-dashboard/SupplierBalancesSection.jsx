...
const SupplierBalancesSection = ({ items, isArabic, isLoading }) => {
  ...
  return (
    <Card variant="elevated" className="mx-auto flex max-h-none w-[calc(100vw-1.5rem)] max-w-[24rem] flex-col overflow-hidden p-3 sm:max-h-[23rem] sm:w-full sm:max-w-[42rem] sm:p-4 xl:max-w-none">
      <div className={cn(
